...
class TestRAGSystemQuery:
    ...
    @patch('rag_system.AIGenerator')
    @patch('rag_system.SessionManager')
    def test_query_calls_ai_generator(self, mock_session, mock_ai_gen_class, mock_vector, mock_doc, test_config):
    ...
    @patch('rag_system.AIGenerator')
    @patch('rag_system.SessionManager')
    def test_query_with_session_includes_history(self, mock_session, mock_ai_gen_class, mock_vector, mock_doc, test_config):
        ...
        mock_session_instance = Mock()
        mock_session.return_value = mock_session_instance
        mock_session_instance.get_conversation_history.return_value = "User: Previous\nAssistant: Previous response"
    ...
    @patch('rag_system.AIGenerator')
    @patch('rag_system.SessionManager')
    def test_query_updates_session_history(self, mock_session, mock_ai_gen_class, mock_vector, mock_doc, test_config):
    ...
    @patch('rag_system.AIGenerator')
    @patch('rag_system.SessionManager')
    def test_query_retrieves_sources_from_tool_manager(self, mock_session, mock_ai_gen_class, mock_vector, mock_doc, test_config):
        ...
        rag.tool_manager.get_last_sources = Mock(return_value=[
            {"course_title": "MCP", "lesson_number": 0}
        ])
...
class TestRAGSystemQueryWithMaxResultsZero:
    ...
    def test_query_with_max_results_zero_returns_no_results(
        self, mock_session, mock_ai_gen_class, mock_vector_class, mock_doc,
        test_config_zero_max_results, mock_vector_store_with_zero_max_results
    ):
        """
        ...
        def mock_generate(query, conversation_history=None, tools=None, tool_manager=None):
            if tool_manager:
                ...
                tool_result = tool_manager.execute_tool("search_course_content", query="what is MCP")
...
class TestRAGSystemQueryContentVsGeneral:
    ...
    @patch('rag_system.AIGenerator')
    @patch('rag_system.SessionManager')
    def test_content_query_uses_search_tool(self, mock_session, mock_ai_gen_class, mock_vector, mock_doc, test_config):
    ...
    @patch('rag_system.AIGenerator')
    @patch('rag_system.SessionManager')
    def test_general_query_may_not_use_tool(self, mock_session, mock_ai_gen_class, mock_vector, mock_doc, test_config):
...
class TestRAGSystemCourseAnalytics:
    ...
    @patch('rag_system.AIGenerator')
    @patch('rag_system.SessionManager')
    def test_get_course_analytics(self, mock_session, mock_ai_gen, mock_vector_class, mock_doc, test_config):
