...
class TestVectorStoreInit:
    ...
    def test_init_creates_collections(self, mock_embedding, mock_client):
        ...
        mock_client_instance.get_or_create_collection = Mock(return_value=collection_mock)
...
class TestVectorStoreSearch:
    ...
    def test_search_with_correct_max_results(self, mock_embedding, mock_client):
        ...
        mock_client_instance.get_or_create_collection = Mock(return_value=mock_collection)
    ...
    @patch('vector_store.chromadb.PersistentClient')
    @patch('vector_store.chromadb.utils.embedding_functions.SentenceTransformerEmbeddingFunction')
    def test_search_with_zero_max_results_returns_empty(self, mock_embedding, mock_client):
        """
    ...
    @patch('vector_store.chromadb.PersistentClient')
    @patch('vector_store.chromadb.utils.embedding_functions.SentenceTransformerEmbeddingFunction')
    def test_search_with_custom_limit_overrides_max_results(self, mock_embedding, mock_client):
...
class TestVectorStoreBuildFilter:
    ...
    def test_build_filter_course_only(self, mock_embedding, mock_client):
        ...
        filter_dict = store._build_filter(course_title="Test Course", lesson_number=None)
